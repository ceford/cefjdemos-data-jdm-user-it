...
![immagine di gattini carini](../../../en/images/security/http-headers/14-http-headers-plugins-headers-kittens.jpg)
...
![attacco man in the middle](../../../en/images/security/http-headers/15-http-headers-plugins-headers-man-in-middle.png)
...
![informazioni certificato tls](../../../en/images/security/http-headers/16-http-headers-plugins-headers-tls.png)
...
![preload hsts](../../../en/images/security/http-headers/17-http-headers-plugins-headers-enter-domain.png)
...
![Scheda politica di sicurezza dei contenuti](../../../en/images/security/http-headers/18-http-headers-plugins-headers-csp.png)
...
![Direttiva politica self](../../../en/images/security/http-headers/19-http-headers-plugins-headers-policy-directive.png)
...
![Direttiva politica self](../../../en/images/security/http-headers/20-http-headers-plugins-headers-policy-directive-self.png)
...
![Stile Joomla http headers 16](../../../en/images/security/http-headers/22-http-headers-plugins-headers-akeeba-style.png)
...
![Impostazioni Joomla nonce](../../../en/images/security/http-headers/23-http-headers-plugins-headers-nonce-settings.png)
...
![Stile Joomla nonce](../../../en/images/security/http-headers/24-http-headers-plugins-headers-nonce-style.png)
...
![Hash degli script Joomla](../../../en/images/security/http-headers/25-http-headers-plugins-headers-csp-script-hashes.png)
...
![Strumenti errore Joomla script hashes](../../../en/images/security/http-headers/26-http-headers-plugins-headers-csp-script-hashes-tools-error.png)
...
![Hash degli script Joomla script src self hash](../../../en/images/security/http-headers/27-http-headers-plugins-headers-csp-script-src-self-hash.png)
...
![Hash degli stili Joomla](../../../en/images/security/http-headers/29-http-headers-plugins-headers-csp-style-hash.png)
