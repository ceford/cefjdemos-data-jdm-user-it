<!--
{
  ...
  "title": "Visualizzazione delle Notizie",
  "description": "", 
  "author": ""
}
-->
...
![Inserimento dati modulo di visualizzazione dei feed](../../../en/images/news-feeds/news-display/01-news-joomla-news-form.png)

Il risultato può essere brutto ma può essere migliorato con alcuni stili personalizzati in user.css:

![Inserimento dati modulo di visualizzazione dei feed](../../../en/images/news-feeds/news-display/02-news-joomla-news-display.png)   
...
![Inserimento dati del componente NewsFeed](../../../en/images/news-feeds/news-display/03-news-feed-data-entry.png)
...
![Inserimento dati voce di menu NewsFeed](../../../en/images/news-feeds/news-display/04-news-feed-menu-form.png)

Verifica: vai al menu del Sito e seleziona l'elemento del menu Feed.

![Visualizzazione NewsFeed](../../../en/images/news-feeds/news-display/05-news-feed-display.png)
...
![Visualizzazione personalizzata NewsFeed](../../../en/images/news-feeds/news-display/06-news-feed-custom-display.png)
...
![Modulo del menu feed di notizie per categoria](../../../en/images/news-feeds/news-display/07-news-feed-menu-category-form.png)
