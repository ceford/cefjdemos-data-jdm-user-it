...
![gestore pacchetti synaptic](../../../en/images/hosting-local/local-hosting-on-linux/01-synaptic-package-manager-gui.png)
...
![pagina predefinita di apache](../../../en/images/hosting-local/local-hosting-on-linux/02-apache-default-page.png)
