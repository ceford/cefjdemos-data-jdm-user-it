...
![Elenco dei menu](../../../en/images/menus/adding-a-new-menu/01-menus-manage.png)
...
- Nel modulo di inserimento dati del menu completa i seguenti campi:
  ...
  - **Descrizione**: Anche se non è richiesta, è spesso utile in un sito con molti menu. Appare sotto il *Titolo* nell'elenco dei menu come illustrato sopra.<br>
    ![Nuovo Menu](../../../en/images/menus/adding-a-new-menu/02-menus-new.png)
- **Salva & Chiudi**
...
![Modulo di inserimento dati del Modulo Menu](../../../en/images/menus/adding-a-new-menu/03-menus-module.png)
...
![Modulo di inserimento dati dell'elemento del menu](../../../en/images/menus/adding-a-new-menu/04-menus-single-article.png)
...
![Visualizzazione del menu](../../../en/images/menus/adding-a-new-menu/05-menus-display.png)
