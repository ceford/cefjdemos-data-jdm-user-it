<!-- Filename: J4.x:Joomla_Standard_Font_Awesome_Fonts / Display title: Font straordinari di Font Awesome   -->

## Come Usare

Il CMS Joomla! viene fornito con il suo set personalizzato di Font Awesome Font. Questi font di icone sono disponibili di default per l'uso nei template *Cassiopeia* e *Atum*.

Le icone font mappate in `/media/system/scss/_icomoon.scss` possono essere richiamate con un tag `name-of-icon">` e uno {spazio} `</span>`. ad esempio:

```html
<span class="icon-joomla"> </span>
```

Mostrerà l'icona di Joomla!: <span class="icon-joomla">&nbsp;</span>

Le icone font che non sono mappate possono essere richiamate con un tag
`<span class="far fa-name-of-icon">` e uno {spazio} `</span>`. Esempio:

```php
<i class="fa fa-adjust"></i>
```

Mostrerà un'icona di regolazione: <i class="fa fa-adjust"></i>

## Dimensione del Font

Poiché le icone sono font, puoi controllarne la dimensione con una classe aggiunta o un'istruzione style=. Naturalmente dovrai definire la classe nel tuo file di foglio di stile .css o .less.
...
Ecco l'icona ridimensionata di Joomla! : <span class="icon-joomla" style="font-size:24px;">&nbsp;</span>
